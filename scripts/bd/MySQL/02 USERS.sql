...
GRANT SELECT ON bd_boleteria.Tarifa TO 'cliente'@'localhost';
...
GRANT SELECT ON bd_boleteria.Entrada TO 'cliente'@'localhost';
...
GRANT SELECT, UPDATE, INSERT ON bd_boleteria.Entrada TO 'organizador'@'localhost';
